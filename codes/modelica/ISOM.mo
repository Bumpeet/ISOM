...
package ISOM
  ...
  model hysys_comparision
    ...
    constant Integer n = 2 "no. of components";
    constant Integer rxns = 1 "no. of reactions";
    
    constant Chemsep_Database.General_Properties comp[n]={comp1, comp2} "comp contains all the components data ";
    constant Real Kij[n,n]={{0, 0.06},{0.06, 0}} "Binary Interaction coefficients";
    constant Real Hf0[n](each unit = "J/mol")={-146711.6263, -153649.33}"Heat of formation of nC5 and iC5 respectively at standard conditions";   
    parameter Real K0[rxns](each unit="1/hr") = { 4.76452E+18}"Pre exponential factor";
    parameter Real E[rxns](each unit = "J/mol")={148930}"activation energy";
    constant Real Z_0[n] = {0.1491, 0.15}"compressiblity factor at standard state";
    constant Real w[n] = {0.25, 0.227} "ascentric factor";
    
    parameter Real P(unit="Pa")=3.2e+6 "inlet stream pressure";
    parameter Real Ti (unit="K")= 150+273.15"inlet temperature";
     
    parameter Real Fi(unit="mol/hr") = 1000*1000;
    parameter Real yi[n] = {1,0} "inlet mole fraction ";
    parameter Real Ca1[n]=Fi*yi/627.0793;
    
    constant Integer reac1[rxns] = {1};
    constant Integer prod1[rxns] = {2};
