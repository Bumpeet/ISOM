  parameter Real E[rxns](each unit = "J/mol")={148.93,154.28,143.17,151.41,150.98,155.92,152.96,149.95,127.28,139.07,64.5,77.06,146.14,160.28,98.28,105.4,3.51,4.79,180.2,400.43, 187.05, 300.79, 51.08, 341.89, 129.75, 88.64,135.45, 129.29, 154.54, 98.63, 150.29, 102.35, 168.13, 90.7, 177.32, 222.9, 59.8, 54.08, 330.28, 329.06, 284.97, 166.32, 165.82, 112.05, 265, 264, 263.5, 265, 295.62, 294.22, 278.81}"activation energy";
   
  parameter Real Fi(unit="mol/hr") = 1000*1000;
  parameter Real yi[n] = {0.05,0,0.05,0.05,0.05,0.05,0.05,0.05,0,0.55, 0, 0, 0.05, 0, 0, 0, 0} "inlet mole fraction ";
  parameter Real Ca1[n]=Fi*yi/1148;
  
  constant Integer reac1[rxns] = {1, 2, 3, 4, 3, 5, 4, 5, 4, 6, 4, 7, 5, 6, 5, 7, 6, 7, 9, 8, 9, 11, 8, 11, 3, 8, 4, 11, 5, 11, 6, 11, 7, 11, 12, 1, 13, 14, 1, 1, 2, 3, 3, 3, 4, 4, 4, 4, 5, 6, 4};
  constant Integer prod1[rxns] = {2, 1, 4, 3, 5, 3, 5, 4, 6, 4, 7, 4, 6, 5, 7, 5, 7, 6, 8, 9, 11, 9, 11, 8, 8, 3, 11, 4, 11, 5, 11, 6, 11, 7, 1, 12, 14, 13, 15, 13, 14, 15, 1, 13, 14, 2, 1, 15, 2, 14, 11};
...
// der(a) calc using Cp_res function which will be used in the delH_res calc
  ...
  for i in 1:rxns loop
    ...
    delH[34] = -delH[33];
    delH[35] = -(delH_ig[10] + delH_res_1[10] + delH_ig[12] + delH_res_1[12]) + ( delH_ig[1] + delH_res_1[1] );
    delH[36] = -delH[35];
    delH[37] = delH_ig[14]-delH_ig[13] + delH_res_1[14]-delH_res_1[13];
    delH[38] = -delH[37];
    delH[39] = (delH_ig[15] + delH_res_1[15] + delH_ig[16] + delH_res_1[16]) - ((delH_ig[1] + delH_res_1[1]) + delH_ig[10] + delH_res_1[10] );
    delH[40] = (delH_ig[13] + delH_res_1[13] + delH_ig[17] + delH_res_1[17]) - ((delH_ig[1] + delH_res_1[1]) + delH_ig[10] + delH_res_1[10] );
    delH[41] = (delH_ig[14] + delH_res_1[14] + delH_ig[17] + delH_res_1[17]) - ((delH_ig[2] + delH_res_1[2]) + delH_ig[10] + delH_res_1[10] );
    delH[42] = (delH_ig[15] + delH_res_1[15] + delH_ig[15] + delH_res_1[15]) - ((delH_ig[3] + delH_res_1[3]) + delH_ig[10] + delH_res_1[10] );
    delH[43] = (delH_ig[1] + delH_res_1[1] + delH_ig[17] + delH_res_1[17]) - ((delH_ig[3] + delH_res_1[3]) + delH_ig[10] + delH_res_1[10] );
    delH[44] = (delH_ig[13] + delH_res_1[13] + delH_ig[16] + delH_res_1[16]) - ((delH_ig[3] + delH_res_1[3]) + delH_ig[10] + delH_res_1[10] );
    delH[45] = (delH_ig[14] + delH_res_1[14] + delH_ig[16] + delH_res_1[16]) - ((delH_ig[4] + delH_res_1[4]) + delH_ig[10] + delH_res_1[10] );
    delH[46] = (delH_ig[2] + delH_res_1[2] + delH_ig[17] + delH_res_1[17]) - ((delH_ig[4] + delH_res_1[4]) + delH_ig[10] + delH_res_1[10] );
    delH[47] = (delH_ig[1] + delH_res_1[1] + delH_ig[17] + delH_res_1[17]) - ((delH_ig[4] + delH_res_1[4]) + delH_ig[10] + delH_res_1[10] );
    delH[48] = (delH_ig[15] + delH_res_1[15] + delH_ig[15] + delH_res_1[15]) - ((delH_ig[4] + delH_res_1[4]) + delH_ig[10] + delH_res_1[10] );
    delH[49] = (delH_ig[2] + delH_res_1[2] + delH_ig[17] + delH_res_1[17]) - ((delH_ig[5] + delH_res_1[5]) + delH_ig[10] + delH_res_1[10] );
    delH[50] = (delH_ig[14] + delH_res_1[14] + delH_ig[16] + delH_res_1[16]) - ((delH_ig[6] + delH_res_1[6]) + delH_ig[10] + delH_res_1[10] );
    delH[51] = (delH_ig[11] + delH_res_1[11] + delH_ig[10] + delH_res_1[10]) - ((delH_ig[4] + delH_res_1[4]) );
...
//component balance
  der(Ca[1]) = ACS*(1/S)*(-r[1] + r[2] + r[35] - r[36] - r[39] - r[40] + r[43] + r[47]);
  der(Ca[2]) = ACS*(1/S)*(r[1] - r[2] - r[41] + r[46] + r[49]);
  der(Ca[3]) = ACS*(1/S)*(-r[3] + r[4] - r[5] + r[6] - r[25] + r[26] -r[42] - r[43] -r[44]);
  der(Ca[4]) = ACS*(1/S)*(r[3] - r[4] -r[7] +r[8] -r[9] + r[10] + r[11] - r[12] - r[45] -r[46] - r[47] - r[48] -r[51]);
  der(Ca[5]) = ACS*(1/S)*(r[5] - r[6] + r[7] - r[8] - r[13] + r[14] - r[15] + r[16] - r[27] + r[28] - r[29] + r[30] - r[49]);
  der(Ca[6]) = ACS*(1/S)*(-r[10] + r[9] + r[13] -r[14] - r[17] + r[18] - r[31] + r[32] - r[50]);
  ...
  der(Ca[10]) = ACS*(1/S)*((r[20] - r[19] - r[21] + r[22])*3  + r[25] - r[26] + r[27] - r[28] + r[29] - r[30] + r[31] - r[32] + r[33] - r[34] - r[35] + r[36] -r[39] - r[40] - r[41] - r[42] - r[43] -r[44] - r[45] -r[46] - r[47] - r[48] - r[49] -r[50] + r[51]);
  der(Ca[11]) = ACS*(1/S)*(r[21] - r[22] + r[23] - r[24]  + r[27] - r[28] + r[29] - r[30] + r[31] - r[32] + r[33] - r[34] + r[51]);
  der(Ca[12]) = ACS*(1/S)*(-r[35] + r[36]);
  der(Ca[13]) = ACS*(1/S)*(-r[37]+r[38]+r[40] + r[44]);
  der(Ca[14]) = ACS*(1/S)*(r[37]-r[38] + r[41] + r[45] + r[50]);
  der(Ca[15]) = ACS*(1/S)*(r[39] + 2*r[42] + 2*r[45]);
  der(Ca[16]) = ACS*(1/S)*(r[39] + r[44] + r[45] + r[50]);
  der(Ca[17]) = ACS*(1/S)*(r[40] + r[41] + r[43] + r[46] + r[47] + r[49]);
