...
package ISOM
      ...
      model hysys_comparision
        ...
        constant Integer rxns = 20 "no. of reactions";
        ...
        parameter Real K0[rxns](each unit="1/hr") = {4.76452E+18,7.21139E+18,33730214071,41497229004,1.04236E+21,2.93778E+21,1.34282E+19,1.34282E+19,2.50046E+14,7.04724E+15,99544918.98,8091314788,4.14972E+13,5.72821E+14,3.87275E+12,3.87275E+13,2177805.536,7379366.791,2.5587E+30,8.67E+25}"Pre exponential factor";
        parameter Real E[rxns](each unit = "J/mol")={148.93,154.28,143.17,151.41,150.98,155.92,152.96,149.95,127.28,139.07,64.5,77.06,146.14,160.28,98.28,105.4,3.51,4.79,180.2,400.43}"activation energy";
        ...
        constant Integer reac1[rxns] = {1, 2, 3, 4, 3, 5, 4, 5, 4, 6, 4, 7, 5, 6, 5, 7, 6, 7, 9, 8};
        constant Integer prod1[rxns] = {2, 1, 4, 3, 5, 3, 5, 4, 6, 4, 7, 4, 6, 5, 7, 5, 7, 6, 8, 9};
      ...
      //component balance
        ...
        der(Ca[9]) = ACS*(1/S)*(r[20] - r[19]);
        der(Ca[10]) = ACS*(1/S)*(r[20] - r[19])*3;
